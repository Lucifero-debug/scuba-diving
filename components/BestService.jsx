...
export default function BestService() {
  return (
    ...
    >
      ...
      >
        <a href="https://wa.me/917678464517?text=Hello%2C%20it%27s%20great%20to%20know%20about%20goasportsadventure.in.%20Help%20me%20with%20the%20Goa%20Tours%20package%20details%20and%20further%20process." className="px-8 py-4 bg-blue-500 text-white font-semibold rounded-full hover:bg-blue-400 transition">
